...
/* harmony import */ var _core_log_response_interceptor__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./core/log-response-interceptor */ 883);
...
AppModule = (0,tslib__WEBPACK_IMPORTED_MODULE_10__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_11__.NgModule)({
        ...
        providers: [
            ...
            { provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_12__.HTTP_INTERCEPTORS, useClass: _core_log_response_interceptor__WEBPACK_IMPORTED_MODULE_9__.LogResponseInterceptor, multi: true },
        ],
        imports: [
...
let DataService = class DataService {
    ...
    getAllBooks() {
        ...
        return this.http.get('/api/books', {
            ...
            .pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.catchError)(error => this.httpHandleError(error)));
    }
